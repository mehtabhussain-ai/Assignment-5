...
let radius: number = 2;
let area: number = calculateArea(radius);
...
//Question 8
console.log("\n\nQuestion 8");
let temperatures: number[] = [25, 28, 30, 22, 27];
...
//Question 10
console.log("\n\nQuestion 10");
let numbersAry:number[]=[-3, -2, -1, 1, 2, 3];
...
//Question 11
console.log("\n\nQuestion 11");
const words: string[] = ["apple", "banana", "orange", "avocado", "grape"];
...
//Question 14
console.log("\n\nQuestion 14");
const arrayNum:number[] = [2,3,4,5];
console.log("Words in Array: " + arrayNum);
const reverseArryNim:number[] = [];
...
function countResult(scores: number[]): void {
